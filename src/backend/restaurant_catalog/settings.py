...
ROOT_URLCONF = 'restaurant_catalog.urls'
...
WSGI_APPLICATION = 'restaurant_catalog.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('POSTGRES_DB', 'restaurant_catalog'),
        'USER': os.getenv('POSTGRES_USER', 'restaurant_catalog_user'),
